...
object ThemeRepository {
    ...
    /** Full list shown in the MainActivity theme row: presets + the photo tile.
     *  (Custom color tile intentionally left out of the row — resolve() below
     *  still supports it if a saved id="custom_color" is ever set again.) */
    fun selectableThemes(settings: KeyboardSettings): List<KeyboardTheme> {
        return presetThemes + customImageTheme()
    }
